...
(function (root, factory) {
    if (typeof module !== 'undefined' && module.exports) {
        ...
        // Browser globals (root is window)
        root.Revstack.crypto=Revstack.crypto || {};
        root.Revstack.crypto.Base64=factory();
        root.returnExports = root.Revstack.crypto.Base64;
    }
}(this, function () {
    var Base64 = {
...
(function (root, factory) {
    if (typeof module !== 'undefined' && module.exports) {
        ...
        if(typeof window !=='undefined'){
            module.exports = factory('../crypto/base64');
        }else{
...
(function (root, factory) {
    ...
    var methods={
        ...
        validate:function(appId,params){
            ...
            }else if(Revstack.id !=="@rid" && params[Revstack.id]){
                params["@rid"]=params[Revstack.id];
                delete params[Revstack.id];
                return null;
            }else{
                return null;
            }
